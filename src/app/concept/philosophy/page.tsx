    ...
    <>
      ...
      <section className="gradient-twilight text-white">
        <div className="max-w-3xl mx-auto px-6 py-24 md:py-32 text-center">
          ...
          <h1 className="text-white mb-6 whitespace-nowrap font-semibold tracking-tight leading-tight text-[clamp(18px,5.2vw,56px)]">
            ユニバーサル・ホスピスマインド
          </h1>
        </div>
      </section>
      ...
      <div className="max-w-[var(--content-narrow)] mx-auto px-4 sm:px-6 py-12">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-4 text-text-secondary leading-relaxed">
              ...
              <p>
                ...
                医療・介護に携わる方だけでなく、ご家族さまの介護をされている方、
        ...
        <ScrollReveal>
          <section className="mb-16">
            ...
            <div className="space-y-4 text-text-secondary leading-relaxed">
              ...
              <p>
                その上で、めぐみ在宅クリニックとして、関わる患者さんとご家族さまが
        ...
        <ScrollReveal>
          <section className="mb-16">
            ...
            <div className="space-y-4 text-text-secondary leading-relaxed">
              <p>
                目標を、患者さんご本人、ご家族さま、そして援助者も穏やかであることとします。
        ...
        <ScrollReveal>
          <section className="mb-16">
            ...
            <p className="text-text-secondary mb-8 leading-relaxed">
              ...
              解決が難しい苦しみを抱えた方の傍らに在り続け、穏やかさに寄り添うことができる能力であり、
              その中核は、苦しみ（希望と現実の開き）と支え（穏やかになれる理由）を言語化し、
              対話を通して関係性を築く力です。
              つまり「治す医療」ではなく「寄り添う医療」を実践できる能力体系です。
            </p>
