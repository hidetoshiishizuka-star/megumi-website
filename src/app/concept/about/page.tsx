  ...
  return (
    <>
        ...
        <div className="max-w-[var(--content-narrow)] mx-auto px-4 sm:px-6 py-12">
          ...
          <ScrollReveal>
            <section className="mb-16">
              <h2 className="heading-section text-navy mb-6">講演実績</h2>
              <p className="text-text-secondary mb-4">
                全国の病院・自治体・学会・学校等で{lectureRecords.length}件以上の講演を行っています。
              </p>
          ...
          <ScrollReveal>
            <section className="mb-16">
              ...
              <div className="space-y-6 text-text-secondary leading-relaxed">
                ...
                <p>
                  めぐみ在宅クリニックとして、関わる患者さんとご家族さまが幸せを実感できる援助を行えているかを、
                  常に問い続けていきたいと考えています。
                </p>
              ...
              <div className="space-y-6 text-text-secondary leading-relaxed">
                <p>
                  目標は、患者さんご本人、ご家族さま、そして援助者も穏やかであること。
                ...
                <p>
                  ...
                  めぐみ在宅クリニックのコンピテンシーとは、解決が難しい苦しみを抱えた方の傍らに在り続け、
                  関わりを通して穏やかさに寄り添うことができる能力です。
                </p>
                <p>
