...
const faqs = [
  {
    q: "どうすれば受診できますか？",
    a: `まずは地域連携室までお電話ください（TEL: ${CLINIC_INFO.tel}、月〜金 9時〜17時）。ご本人やご家族さまの状況をお伺いし、訪問診療の開始について調整いたします。緊急性が高い場合は早急に対応します。`,
  },
  {
    q: "家で最期を迎えることはできますか？",
    a: "ご自宅で最期まで過ごされている方もいらっしゃいます。痛みの苦しみを和らげ、穏やかに過ごせるよう支援します。お一人暮らしの方も、状況に応じてご相談しながら対応いたします。",
  },
  {
    q: "夜間や休日も緊急往診に来てもらえますか？",
    a: "夜間・休日も緊急往診しております。医師が、24時間365日対応できる体制をとっておりますので、いつでもご連絡ください。",
  },
  {
    q: "費用はどれくらいかかりますか？",
    a: "訪問回数や治療内容、保険の負担割合により変動します。1割負担で月2回訪問した場合、約8,000円が目安です。詳しくは「費用について」ページをご覧いただくか、お問い合わせください。",
  },
  {
    q: "在宅療養が困難になった時はどうなりますか？",
    a: "連携先の病院と速やかに連携し、対応いたします。状況に合わせた最適な療養環境を一緒に考えます。入院治療が必要となった場合には、ご家族さまの方と相談の上、対応していただける医療機関に連携をはかり、入院の調整も行います。",
  },
  {
    q: "ケアマネジャーや訪問看護は紹介してもらえますか？",
    a: "各地域の経験豊富な訪問看護ステーション・ケアマネジャーをご紹介いたします。",
  },
  {
    q: "薬は持ってきてもらえますか？",
    a: "訪問薬剤師が自宅にお届けする「訪問服薬」が利用可能です。薬代の他に別途料金がかかります（介護保険で1回500〜600円程度）。",
  },
  {
    q: "診療費の支払いはどうなりますか？",
    a: "1か月分をまとめて翌月に請求いたします。訪問時に現金でのお支払い、または口座引き落としに対応しています。",
  },
  {
    q: "訪問可能な地域を教えてください。",
    a: `${CLINIC_INFO.areas.join("・")}を中心に、クリニックから原則5km圏内を対象としています。詳しくは「診療案内」ページの訪問対応エリアをご覧ください。`,
  },
  {
    q: "紹介からどのくらいで初回訪問ができますか？",
    a: "できる限り迅速に初回訪問を調整いたします。緊急性の高い場合は最優先で対応します。まずはお電話でご相談ください。",
  },
  {
    q: "どのような病気・状態の方が対象ですか？",
    a: "がん末期、神経難病（ALS・パーキンソン病等）、認知症、心不全、呼吸器疾患、腎疾患などの慢性疾患のほか、人工呼吸器や在宅酸素の管理が必要な方まで幅広く対応しています。詳しくは「診療案内」ページをご覧ください。",
  },
];
