          ...
          <ScrollReveal>
            <section className="mb-16">
              <div className="bg-navy-light rounded-2xl p-8">
                ...
                <p className="text-text-secondary leading-relaxed mb-4">
                  人生の目的は幸せになること。
                  解決できる苦しみは他の医療でも提供できますが、
                  解決が難しい苦しみを抱えた人が幸せになれる援助を学ぶ機会は少ないのが現状です。
                  当院では、苦しみの中にあっても穏やかさを取り戻せるような関わり方——
                  「ユニバーサル・ホスピスマインド」を、日々の診療の中で実践的に学ぶことができます。
                </p>
                <p className="text-text-secondary leading-relaxed mb-4">
                  ACP（アドバンス・ケア・プランニング）は、単に「最期をどうするか」を決めることではありません。
                  治療の差し控えという判断を、患者さんご本人やご家族と共に考え、
                  対話を重ねながら意思決定を支えていく——それが本来のACPです。
                  当院では、こうした倫理的な判断が求められる場面に日常的に向き合っています。
                  教科書では学べない、具体的な患者さんやご家族との関わりを実践の中で学べる場として、
                  ぜひご検討ください。
                </p>
