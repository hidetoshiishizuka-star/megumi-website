...
const faqs = [
  {
    q: "どうすれば受診できますか？",
    a: `まずは地域連携室までお電話ください（TEL: ${CLINIC_INFO.tel}、月〜金 9時〜17時）。ご本人やご家族の状況をお伺いし、訪問診療の開始について調整いたします。緊急性が高い場合は早急に対応します。`,
  },
  {
    q: "家で最期を迎えることはできますか？",
  ...
  },
  {
    ...
    a: "連携先の病院と速やかに連携し、対応いたします。状況に合わせた最適な療養環境を一緒に考えます。入院治療が必要となった場合には、ご家族の方と相談の上、対応していただける医療機関に連携をはかり、入院の調整も行います。",
  },
  {
